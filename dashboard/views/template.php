<?php
  //echo "Test Plantilla del Dashboard";
  // Capturar parametros de la URL
  // echo "<pre>";print_r($_SERVER);echo"</pre>";
  $routesArray = explode("/",$_SERVER["REQUEST_URI"]);
  // La posicion 0 se origina por: /admins/empleados, por el primer "/" que viene 0
  array_shift($routesArray);  // Elimina la posicion 0
  // echo "<pre>";print_r($routesArray);echo "</pre>";

  // Cuando se compone en la URL : /admins/empleados/edit?var1=get1&var2=get2&var3=get3
  // Separar el ? (varaibles de tipo GET)
  // obtiene "var1"
  foreach ($routesArray as $key => $value){
    $routesArray[$key] = explode("?",$value)[0]; // Se obtiene solo el indice 0 el primero
  }
  /*
    [0] = admins
    [1] = configuration
...
?>
  ...
  <!-- ! y Enter  para generar codigo HTML basico -->
